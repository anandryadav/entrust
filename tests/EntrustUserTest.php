...
use Firmway\Entrust\Contracts\EntrustUserInterface;
use Firmway\Entrust\Traits\EntrustUserTrait;
use Illuminate\Cache\ArrayStore;
use Illuminate\Support\Facades\Config;
use Illuminate\Support\Facades\Cache;
use Firmway\Entrust\Permission;
use Firmway\Entrust\Role;
use Mockery as m;
...
class EntrustUserTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $permMock = m::mock('Firmway\Entrust\Permission');
    ...
    {
        $roleMock = m::mock('Firmway\Entrust\Role');
